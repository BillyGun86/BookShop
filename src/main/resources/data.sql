...
insert into authors (userName) values ('Drucie Goodbourn');
insert into authors (userName) values ('Marcia Aggiss');
insert into authors (userName) values ('Giovanni Bigg');
insert into authors (userName) values ('Duffie Eynon');
insert into authors (userName) values ('Anselma McKennan');
insert into authors (userName) values ('Gert Kira');
insert into authors (userName) values ('Clerc Djakovic');
insert into authors (userName) values ('Stacee Elsy');
insert into authors (userName) values ('Dorotea Bonhill');
insert into authors (userName) values ('Minni Bunney');
insert into authors (userName) values ('Berty Gandley');
insert into authors (userName) values ('Raynard Tesdale');
insert into authors (userName) values ('Joanna Hutfield');
insert into authors (userName) values ('Dannie Glidder');
insert into authors (userName) values ('Timmie Adshede');
insert into authors (userName) values ('Fernando Neads');
insert into authors (userName) values ('Teddy Guilliland');
insert into authors (userName) values ('Paloma Grebert');
insert into authors (userName) values ('Kristos Usher');
insert into authors (userName) values ('Darcey Rohmer');
insert into authors (userName) values ('Cristie Isacsson');
insert into authors (userName) values ('Lindsay Coutthart');
insert into authors (userName) values ('Helyn Schneidar');
insert into authors (userName) values ('Bette-ann Askem');
insert into authors (userName) values ('Dom Robuchon');